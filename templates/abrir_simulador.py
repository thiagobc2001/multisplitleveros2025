...
def login():
    fornecedores = ['LG', 'Fujitsu']  # Adicione mais fornecedores aqui se precisar
...
@app.route('/simulador')
def simulador():
    fornecedor = session.get('fornecedor', 'LG')  # Garantir que o fornecedor é LG por padrão
    caminho_json = f'/static/data/{fornecedor}/'  # Caminho para os arquivos JSON corretos
